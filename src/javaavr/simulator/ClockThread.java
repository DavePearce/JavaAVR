...
public class ClockThread extends Thread {
  ...
  /**
   * Set the delay between clock pulses. This effectively sets the frequency of the clock.
   *
   * @param delay
   */
  ...
  /**
   * Set a clock multiplier. This is use to speed up the physical execution of the simulation for
   * the purposes of debugging, etc. It essentially enables a kind of "fast forward".
   *
   * @param multiplier
   */
